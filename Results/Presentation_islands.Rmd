...
classic_layers_turnover_with_distances %>%
  ggplot(aes(x=distance_in_km, y=turnover))+ geom_point(color = "#FB3B1E")+ theme_classic()+ 
  stat_smooth(method= "lm", se=F, color = "#FB3B1E")+
...
turnover_shuf_and_empirical %>% ggplot(aes(x= distance_in_km, y= ave, group= type, color= type))+
  ...
  labs(x="Distance in Km", y="Jaccard Similarity")+ scale_color_manual(values = c("#FB3B1E", "#15B7BC", "#72A323", "#BE75FA" )) +
  theme(panel.grid = element_blank(),
        panel.border = element_rect(color = "black",fill = NA,size = 1),
        panel.spacing = unit(0.5, "cm", data = NULL),
        axis.text = element_text(size=14, color='black'),
...
modules_with_lat_lon_id %>% 
  ...
  scale_x_continuous(breaks=seq(1,88,4))+ labs(y="Number of islands", x="Module number")+
...
jaccard_similarity_layer_empirical_and_null_km %>% 
  ...
  geom_point()+ geom_errorbar(aes(ymin= ave-sd, ymax= ave+sd))+ theme_classic()+ geom_smooth(method= "lm", se=F)+
  theme(axis.title=element_text(size=22))+theme(axis.text.x=element_text(size=15))+
  theme(axis.text.y=element_text(size=15))+ theme(legend.title = element_text(size = 13), legend.text = element_text(size = 13))+ scale_color_manual(values = c("#FB3B1E", "#15B7BC", "#72A323", "#A44CD3" ))+
  labs(x="Distance in Km", y="Jaccard Similarity")+ 
...
group_color <- c(shuf_pollinators = "#A44CD3", 
                    shuf_plants = "#72A323",
                    shuf_both = "#15B7BC")
...
jaccard_similarity_layer_empirical_and_null_km_classic %>% 
  ...
  geom_point()+ geom_errorbar(aes(ymin= ave-sd, ymax= ave+sd))+ theme_classic()+ geom_smooth(method= "lm", se=F)+
  theme(axis.title=element_text(size=22))+theme(axis.text.x=element_text(size=15))+
  theme(axis.text.y=element_text(size=15))+ theme(legend.title = element_text(size = 13), legend.text = element_text(size = 13))+ scale_color_manual(values = c("#FB3B1E","#FA86F2"))+
  labs(x="Distance in Km", y="Jaccard Similarity")+ 
  stat_cor(aes(label = after_stat(rr.label)), label.x = 400, label.y = c(0.60, 0.56, 0.52, 0.48))+
  theme(panel.grid = element_blank(),
        panel.border = element_rect(color = "black",fill = NA,size = 1),
...
iteration_correlation_classic %>% ggplot(aes(x = rsquared))+ 
  geom_density(fill = "#FA86F2", color = "#FA86F2", alpha = 0.5)+ 
  theme_classic()+ labs(x = "R squared")+
...
jaccard_similarity_layer_empirical_and_null_km %>% 
  ...
  geom_point()+ geom_errorbar(aes(ymin= ave-sd, ymax= ave+sd))+ theme_classic()+ geom_smooth(method= "lm", se=F)+
  theme(axis.title=element_text(size=22))+theme(axis.text.x=element_text(size=15))+
  theme(axis.text.y=element_text(size=15))+ theme(legend.title = element_text(size = 13), legend.text = element_text(size = 13))+ scale_color_manual (values = c("#FB3B1E",  "#E6AB02" ))+
  labs(x="Distance in Km", y="Jaccard Similarity")+ 
  stat_cor(aes(label = after_stat(rr.label)), label.x = 400, label.y = c(0.60, 0.56, 0.52, 0.48))+
  theme(panel.grid = element_blank(),
        panel.border = element_rect(color = "black",fill = NA,size = 1),
...
iteration_correlation_interactions %>% ggplot(aes(x = rsquared))+ 
  geom_density(fill =  "#E6AB02" , color =  "#E6AB02" , alpha = 0.6)+ 
  theme_classic()+ labs(x = "R squared")+
...
jaccard_similarity_empirical_and_fixed_no_self_loop_km %>% ggplot(aes(x= ave_dist_in_km, y= ave, group= type, color= type))+
  ...
  labs(x="Distance in Km", y="Jaccard Similarity")+ scale_color_manual(values = c("#FB3B1E", "#666666"))+
  theme(panel.grid = element_blank(),
        panel.border = element_rect(color = "black",fill = NA,size = 1),
        panel.spacing = unit(0.5, "cm", data = NULL),
        axis.text = element_text(size=14, color='black'),
