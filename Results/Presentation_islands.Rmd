...
\
Shuffling species between islands deviates more from the empirical value than shuffling interactions between islands, which indicates species turnover is the main driver of distance decay in structure.
```{r, message=FALSE}
