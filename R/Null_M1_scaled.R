...
jaccard_similarity_layer_empirical_and_null_km %>% 
  ...
  scale_color_manual(name = "Models",  labels = c("E",expression("NM"[1]^AP), expression("NM"[1]^P),
...
##correlation and slope squared between jaccard and distance for each run ----------------------------------------------------------------------------
...
iteration_correlation_pols_NM1 <- iteration_correlation_pols %>% mutate(type = "shuf_pollinators")
