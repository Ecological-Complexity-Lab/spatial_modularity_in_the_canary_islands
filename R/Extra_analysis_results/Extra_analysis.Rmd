...
#  ??!!למה 
To try to understand why we get this pattern in the empirical network, we look into the distribution of modules across layers with higher (0.9) and lower (0.1) interedges values.
\
\
