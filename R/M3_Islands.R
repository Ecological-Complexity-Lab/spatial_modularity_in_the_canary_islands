...
#write.csv(intralayers_with_ids_for_shuf , "./csvs/Islands/Jac/intralayers_with_ids_for_shuf.csv", row.names = FALSE)
...
#write.csv(shuf_null_edge_list_classic, "./csvs/Islands/Jac/shuf_null_edge_list_classic_islands_as_layers.csv", row.names = FALSE)
...
#write.csv(dryad_multilayer_shuf_1000_classic_output, "./csvs/Islands/Jac/dryad_multilayer_shuf_1000_classic_output_islands.csv", row.names = FALSE)

##---- Distance decay of modules  ---------------------------------------------------------------
distances_with_ids <- read.csv("./csvs/Islands/distances_with_ids_islands_as_layers.csv")
dryad_multilayer_shuf_1000_classic_output<- read.csv("./csvs/Islands/Jac/dryad_multilayer_shuf_1000_classic_output_islands.csv")
...
#write.csv(all_edge_list_islands_combine_no_module_shuf_classic_output, "./csvs/Islands/Jac/all_edge_list_islands_combine_no_module_shuf_classic.csv", row.names = FALSE)

#---- create ave for jaccard layers-------------------------------------------------------------------------
all_edge_list_islands_combine_no_module_shuf_classic_output <- read.csv("./csvs/Islands/Jac/all_edge_list_islands_combine_no_module_shuf_classic.csv")
...
#write.csv(jaccard_similarity_layer_empirical_and_null_km_classic,"./csvs/Islands/Jac/jaccard_similarity_layer_empirical_and_null_km_classic_islands.csv", row.names = FALSE)


#---- graphs for distance decay in modules shuf vs empirical--------------------------------
#jaccard_similarity_layer_empirical_and_null_km_classic <- read.csv("./csvs/Islands/Jac/jaccard_similarity_layer_empirical_and_null_km_classic_islands.csv") #need to read this to run next part

pdf('./graphs/Islands/Jac/M3_Modules_DD_Islands.pdf', 10, 6)
...
#write.csv(iteration_correlation_classic, "./csvs/Islands/Jac/iteration_correlation_classic_islands.csv", row.names = FALSE)
...
pdf('./graphs/Islands/Jac/M3_r_squares_module_DD.pdf', 10, 6)
...
iteration_correlation_classic<-na.omit(iteration_correlation_classic)
