...
module_data_with_loc <- read.csv("./csvs_nuevo/modules_with_lat_lon_islands_as_layers.csv")
...
empirical_turnover_for_module_island_shuf_no_self_loop_km <- read.csv("./csvs_nuevo/islands_turnover_with_distnace_empirical.csv")
...
Fig_4<-ggdraw()+ draw_plot(Canary_map)+
