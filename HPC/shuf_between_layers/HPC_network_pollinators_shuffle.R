...
interlayer_edges_shuf <- read.csv("./interlayer_edges_shuf.csv")
...
write.csv(interlayers_new_shuf, paste("csvs_pollinators/", trial_num,'_interlayers_new_shuf.csv', sep=''), row.names = FALSE)
