...
interlayer_edges_shuf_plants <- read.csv("./interlayer_edges_shuf_plants.csv")
...
write.csv(interlayers_new_shuf_plants, paste("csvs_plants/", trial_num,'_interlayers_new_shuf_plants.csv', sep=''), row.names = FALSE)
