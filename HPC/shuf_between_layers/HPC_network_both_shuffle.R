...
interlayer_edges_shuf_both <- read.csv("./interlayer_edges_shuf_both.csv")
...
write.csv(interlayers_new_shuf_both, paste("csvs_both/", trial_num,'_interlayers_new_shuf_plants.csv', sep=''), row.names = FALSE)
